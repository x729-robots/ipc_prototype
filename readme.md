...
## TODO
    ...
    - Доработать механизм условной переменной на возможность работы через разделяемую память
    
    - Реализовать условную переменную через именованный семафор в разделяемой памяти - это более работоспособный вариант

    - Уточнить у возможна ли синхронизация периодов и фаз двух сред исполнения прикладных модулей - это был бы третий вариант синхронизации, когда дополнительные механизмы синхронизации вообще не требуются (кроме CLOCK_MONOTONIC)
