...
typedef std::array<signal, DUMMY_SIGNALS_DICT_SIZE_IN> T_dummy_signals_dictionary_in;
typedef std::array<signal, DUMMY_SIGNALS_DICT_SIZE_OUT> T_dummy_signals_dictionary_out;
